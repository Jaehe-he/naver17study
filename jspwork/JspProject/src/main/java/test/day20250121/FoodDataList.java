...
public class FoodDataList {
	...
	public FoodDataList() {
		...
		list.add(new FoodDto("콘치즈", "5.jpg", 15000, "2025-02-12", 5));
		list.add(new FoodDto("치즈샌드위치", "치즈샌드위치.jpg",20000, "2024-12-25", 6));
		list.add(new FoodDto("짜장라면", "짜장라면.jpg", 5000, "2024-11-30", 2));
	}
