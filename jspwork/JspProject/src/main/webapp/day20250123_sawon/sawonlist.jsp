...
<meta charset="UTF-8">
	...
	$(function(){
		...
		$("#btnsearch").click(function(){
			...
			//목록 파일로 이동 - 검색단어는 get방식으로 전달
			location.href="./sawonlist.jsp?search="+search; //자기 자신 호출(sawonlist.jsp)
		});
...
<%
	//검색단어 search 읽기
	//sawonlist.jsp를 직접 실행 시에는 search라는 name값이 안넘어온다
	//이 경우에는 search 변수값은 null이 된다
	...
	//전체 데이터 가져오기
	List<SawonDto> list = dao.getAllDatas(search);//search를 getAllDatas()로 넘겨야함 => ()안에 search를 넣으면 SawonDao.java에서도 수정해줘야함
%>
<body>
